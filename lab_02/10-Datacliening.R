...
# Load dữ liệu
alcohol <- read.csv("C:/Users/user/OneDrive/Desktop/PTVTQHD/data/student-alcohol.csv")
View(alcohol)
#Xem 6 dòng đầu tiên
head(alcohol)
...
#Loại bỏ cột đầu tiền(có thể là cột ID không cần thiết)
head(alcohol[,-1]) #Xóa cột 1
...
#Diền missing values bằng median
...
#Điền giá trị "orther" cho dòng 63 (Mjob bị thiếu)
...
#Biến nhị phân đơn giản(birnary variables)
#School: GP/MS
